...
export function Navbar() {
    ...
    const navItems = [
        ...
        },
        {
            ...
            action: () => scrollToSection('leistungen'),
            isPage: false
        },
        {
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 flex justify-start">
                <Link to={language === 'en' ? '/en' : '/'} className="flex items-center gap-4 group transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] hover:opacity-80">
                    <img
                        src="/BringsAI.png"
                        alt="BringsAI"
                        className="h-10 sm:h-14 lg:h-16 w-auto transition-all duration-300"
                    />
                    <span className="text-xl lg:text-2xl font-bold tracking-tight hidden sm:block text-[var(--foreground)]">
                        BringsAI
                    </span>
                </Link>
            </div>
            ...
            <AnimatePresence>
                {mobileMenuOpen && (
                    <motion.div
                        ...
                        className="absolute top-16 sm:top-24 left-0 right-0 rounded-2xl border border-[var(--border)] bg-[var(--card)]/95 p-6 shadow-lg backdrop-blur-xl min-[1150px]:hidden"
                    >
