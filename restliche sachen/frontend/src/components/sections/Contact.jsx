    ...
    return (
        <section id="contact" className="relative overflow-hidden bg-[var(--background)] py-20 sm:py-28">
            ...
            <div 
                ...
                style={{
                    background: 'radial-gradient(ellipse 80% 60% at 50% 100%, rgba(59,130,246,0.08) 0%, transparent 50%), radial-gradient(ellipse 60% 40% at 70% 80%, rgba(139,92,246,0.06) 0%, transparent 40%)',
                }}
            />
            ...
            <div className="mx-auto max-w-4xl px-6 sm:px-8 relative z-10">
                ...
                >
                    {/* Top glow line */}
                    <div className="absolute top-0 left-[10%] right-[10%] h-[1px] bg-gradient-to-r from-transparent via-[var(--accent)]/40 to-transparent" />
