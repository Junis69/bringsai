                            ...
                            <Reveal key={study.id} direction={directions[idx % directions.length]} delay={idx * 0.15}>
                                ...
                                >
                                    <div className={`relative flex flex-col h-full rounded-2xl border-0 overflow-hidden cursor-pointer hover:shadow-2xl hover:scale-[1.02] transition-all duration-500`}>
                                        {/* Top visual part - solid color */}
                                        <div className={`h-56 flex items-center justify-center ${style.bg} transition-all duration-500`}>
                                        ...
                                        {/* Bottom text part */}
                                        <div className="p-7 flex-grow flex flex-col bg-[var(--card)] relative z-20 border border-[var(--border)] border-t-0 rounded-b-2xl">
