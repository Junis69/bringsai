...
export function PageCTA({ title, subtitle, buttonText }) {
    ...
    return (
        <Reveal direction="up" delay={0.1}>
            <section className="mt-16 rounded-2xl border border-[var(--border)] bg-[var(--card)] p-8 md:p-12 text-center shadow-sm hover:shadow-md transition-shadow duration-500 relative overflow-hidden">
                <div className="relative z-10">
                    ...
                    <a
                        ...
                        className="inline-flex items-center justify-center px-10 py-4 text-lg font-bold text-white bg-[var(--accent)] hover:bg-[var(--accent-hover)] border-0 rounded-full transition-all duration-300 group"
                    >
